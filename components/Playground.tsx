export default function Playground() {
  return (
    <section id="workbench" className="site_section">
      <h2 className="section_heading">Workbench</h2>

      <div className="card_grid">
        <a
          href="/workbench/aes-explorer"
          className="surface_card group block"
        >
          ...
          <p className="mt-2 font-sans text-sm leading-relaxed text-slate-400">
            Explore 24,625 presidential directives on a liberal-conservative
            scale, with ideology filters, party distributions, presidential
            means, and NOMINATE validation.
          </p>
        ...
        >
          ...
          <p className="mt-2 font-sans text-sm leading-relaxed text-slate-400">
            ...
            Jaccard overlap between classes to decide: sparse (TF-IDF) or dense
            (neural)?
          </p>
          <span className="mt-3 inline-block text-xs font-medium uppercase tracking-widest text-slate-600 transition-colors group-hover:text-slate-400">
            Try it &rarr;
        ...
        >
          ...
          <p className="mt-2 font-sans text-sm leading-relaxed text-slate-400">
            ...
            floor? Eight decades of vocabulary divergence across the
